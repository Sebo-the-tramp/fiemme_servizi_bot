...
The service is basically a reminder service for perople leaving in val di Fiemme
...
We used a microservices approach, and we used lambda functions for it,
...
The lambda functions used also a shared library that we uploaded alltogether
